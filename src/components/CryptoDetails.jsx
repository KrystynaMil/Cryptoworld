...
const CryptoDetails = () => {
  ...
  const time = ['3H', '24H', '1 WEEK', '1 MONTH', '3 MONTHS', '1 YEAR', '3 YEARS', '5 YEARS'];
    ...
    <Col className="stats-container">
      <Col className="coin-value-statistics">
        <Col className="coin-value-statistics-heading">
          ...
          <p>
            An overview showing the statistics of {cryptoDetails?.name} , such as the base and quote currency, the rank, and trading volume.</p>
        </Col>
